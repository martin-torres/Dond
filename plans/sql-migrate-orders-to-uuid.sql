...
BEGIN
    ...
    RAISE NOTICE 'order_items.order_id type: %', (SELECT data_type FROM information_schema.columns WHERE table_name = 'order_items' AND column_name = 'order_id');
    RAISE NOTICE '';
    RAISE NOTICE 'You can now run Step 3 of the main migration script.';
END $$;
