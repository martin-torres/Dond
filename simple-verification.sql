-- Simple verification script for item-level status system
-- This version uses simpler queries that work with your Supabase setup

-- 1. Check what columns exist in order_items
SELECT 
  column_name,
  data_type,
  is_nullable,
...
-- 9. Add station constraint if missing
DO $$
BEGIN
  BEGIN
...
-- 10. Create functions if they don't exist
...
-- 11. Create triggers (drop and recreate to ensure they exist)
...
-- 12. Update existing data to have proper assignments
UPDATE order_items 
